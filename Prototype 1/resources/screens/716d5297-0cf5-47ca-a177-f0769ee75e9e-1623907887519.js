jQuery("#simulation")
  .on("click", ".s-716d5297-0cf5-47ca-a177-f0769ee75e9e .click", function(event, data) {
  ...
  .on("pageload", ".s-716d5297-0cf5-47ca-a177-f0769ee75e9e .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
