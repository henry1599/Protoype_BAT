jQuery("#simulation")
  .on("click", ".s-da2b81d6-b3c3-402a-9aad-5b8f5ab11fde .click", function(event, data) {
  ...
  .on("click", ".s-da2b81d6-b3c3-402a-9aad-5b8f5ab11fde .toggle", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
                ...
                "actions": [
                  {
                    ...
                    "parameter": [ {
                      "#s-da2b81d6-b3c3-402a-9aad-5b8f5ab11fde #s-Image_13 svg": {
                        "attributes": {
                          "overlay": "#E84834"
                        }
                      }
