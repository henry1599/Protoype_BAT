jQuery("#simulation")
  .on("click", ".s-e2ff238e-0a09-491a-b555-00f241340276 .click", function(event, data) {
  ...
  .on("click", ".s-e2ff238e-0a09-491a-b555-00f241340276 .toggle", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
                ...
                "actions": [
                  {
                    ...
                    "parameter": [ {
                      "#s-e2ff238e-0a09-491a-b555-00f241340276 #s-Image_41 svg": {
                        "attributes": {
                          "overlay": "#757676"
                        }
                      }
  ...
  .on("pageload", ".s-e2ff238e-0a09-491a-b555-00f241340276 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
