jQuery("#simulation")
  .on("click", ".s-64d1b6f5-abc7-459e-8cc0-d03224bb37c5 .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/b7fb5df5-91d8-4dab-ba9c-5e4a6d2e96f0",
                    "transition": {
                      "type": "slideright",
                      "duration": 700
                    }
  ...
  .on("click", ".s-64d1b6f5-abc7-459e-8cc0-d03224bb37c5 .toggle", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
                ...
                "actions": [
                  {
                    ...
                    "parameter": [ {
                      "#s-64d1b6f5-abc7-459e-8cc0-d03224bb37c5 #s-Image_13 svg": {
                        "attributes": {
                          "overlay": "#E84834"
                        }
                      }
  ...
  .on("pageload", ".s-64d1b6f5-abc7-459e-8cc0-d03224bb37c5 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
