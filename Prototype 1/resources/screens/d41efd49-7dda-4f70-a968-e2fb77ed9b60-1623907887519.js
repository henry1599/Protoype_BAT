jQuery("#simulation")
  .on("click", ".s-d41efd49-7dda-4f70-a968-e2fb77ed9b60 .click", function(event, data) {
  ...
  .on("pageload", ".s-d41efd49-7dda-4f70-a968-e2fb77ed9b60 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
