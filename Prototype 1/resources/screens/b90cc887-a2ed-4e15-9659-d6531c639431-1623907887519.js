jQuery("#simulation")
  .on("click", ".s-b90cc887-a2ed-4e15-9659-d6531c639431 .click", function(event, data) {
  ...
  .on("click", ".s-b90cc887-a2ed-4e15-9659-d6531c639431 .toggle", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
                ...
                "actions": [
                  {
                    ...
                    "parameter": [ {
                      "#s-b90cc887-a2ed-4e15-9659-d6531c639431 #s-Image_13 svg": {
                        "attributes": {
                          "overlay": "#E84834"
                        }
                      }
  ...
  .on("pageload", ".s-b90cc887-a2ed-4e15-9659-d6531c639431 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
