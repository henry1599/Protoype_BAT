jQuery("#simulation")
  .on("click", ".s-f0a8a869-39a0-4d83-89a8-224bf4f1c1d5 .click", function(event, data) {
  ...
  .on("pageload", ".s-f0a8a869-39a0-4d83-89a8-224bf4f1c1d5 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
