jQuery("#simulation")
  .on("click", ".s-083f9eef-86bb-42d9-a168-096d6e8f7b37 .click", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": {
                    "target": "screens/716d5297-0cf5-47ca-a177-f0769ee75e9e",
                    "transition": {
                      "type": "slideleft",
                      "duration": 700
                    }
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/a401bd9e-a149-4f0a-aaf1-8fa60d4de81a",
                    "transition": {
                      "type": "slideleft",
                      "duration": 700
                    }
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/70377dc7-b84b-4cb7-83c6-5bfce8e51adc",
                    "transition": {
                      "type": "slideleft",
                      "duration": 700
                    }
  ...
  .on("pageload", ".s-083f9eef-86bb-42d9-a168-096d6e8f7b37 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
