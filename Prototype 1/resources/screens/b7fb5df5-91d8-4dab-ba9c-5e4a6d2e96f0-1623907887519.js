jQuery("#simulation")
  .on("click", ".s-b7fb5df5-91d8-4dab-ba9c-5e4a6d2e96f0 .click", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": {
                    "target": "screens/da2b81d6-b3c3-402a-9aad-5b8f5ab11fde",
                    "transition": {
                      "type": "slideleft",
                      "duration": 700
                    }
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/64d1b6f5-abc7-459e-8cc0-d03224bb37c5",
                    "transition": {
                      "type": "slideleft",
                      "duration": 700
                    }
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/b90cc887-a2ed-4e15-9659-d6531c639431",
                    "transition": {
                      "type": "slideleft",
                      "duration": 700
                    }
  ...
  .on("pageload", ".s-b7fb5df5-91d8-4dab-ba9c-5e4a6d2e96f0 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
