jQuery("#simulation")
  .on("click", ".s-3b1e6b01-65d3-478f-8fa5-dc1390d38a00 .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/f0a8a869-39a0-4d83-89a8-224bf4f1c1d5"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("pageload", ".s-3b1e6b01-65d3-478f-8fa5-dc1390d38a00 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
