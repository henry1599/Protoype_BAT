jQuery("#simulation")
  .on("click", ".s-70976b24-3dd8-497b-b9f1-8c8ab97cdf0b .click", function(event, data) {
  ...
  .on("pageload", ".s-70976b24-3dd8-497b-b9f1-8c8ab97cdf0b .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
