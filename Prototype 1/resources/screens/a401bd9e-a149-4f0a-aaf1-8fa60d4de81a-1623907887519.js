jQuery("#simulation")
  .on("click", ".s-a401bd9e-a149-4f0a-aaf1-8fa60d4de81a .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/083f9eef-86bb-42d9-a168-096d6e8f7b37",
                    "transition": {
                      "type": "slideright",
                      "duration": 700
                    }
  ...
  .on("pageload", ".s-a401bd9e-a149-4f0a-aaf1-8fa60d4de81a .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
